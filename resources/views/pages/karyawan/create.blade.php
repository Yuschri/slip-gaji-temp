    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="">
                        <h1 class="fs-3 mb-1">Add Karyawan</h1>
                        <p class="mb-0">Add a new employee record manually</p>
                    </div>
                    <div>
        ...
        <div class="card p-4">
            <form action="{{ route('karyawan.store') }}" method="POST">
                ...
                <div class="mt-5">
                    <button type="submit" class="btn btn-primary btn-lg">Save Karyawan</button>
