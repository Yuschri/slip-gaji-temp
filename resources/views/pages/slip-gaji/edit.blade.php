            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="mb-0">Update employee payslip record</p>
                    </div>
                    <div>
            ...
            <form action="{{ route('slip-gaji.update', $slip->id_slip) }}" method="POST" id="slipGajiForm">
                ...
                <div class="tab-content" id="slipGajiTabContent">
                        ...
                        <div class="row g-3 mb-4 border-top pt-3 mt-2">
                            <div class="col-md-5">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_resign" id="is_resign" value="1"
                                        {{ old('is_resign', isset($slip) && isset($slip->is_resign) && $slip->is_resign ? 'checked' : '') }}>
                                    <label class="form-check-label fw-bold text-danger" for="is_resign">
                                        <i class="ti ti-user-minus me-1"></i> Slip Gaji Karyawan Resign
                                    </label>
                                </div>
                                <div class="form-text text-muted">Centang jika ini adalah slip gaji untuk karyawan yang resign.</div>
                            </div>
                            <div class="col-md-4" id="col_tanggal_resign" style="{{ old('is_resign', isset($slip) && isset($slip->is_resign) && $slip->is_resign ? '' : 'display:none;') }}">
                                <label class="form-label fw-semibold text-danger">Tanggal Terakhir Bekerja / Resign <span class="text-danger">*</span></label>
                                <input type="date" name="tanggal_resign" id="tanggal_resign" class="form-control border-danger"
                                    value="{{ old('tanggal_resign', isset($slip) && isset($slip->tanggal_resign) ? $slip->tanggal_resign : '') }}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="lain_lain" id="lain_lain"
                                        class="form-control entry-calc entry-calc-rupiah"
                                        value="{{ old('lain_lain', $slip->pendapatan_lainnya) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" name="penyesuaian_gaji_lalu" id="penyesuaian_gaji_lalu"
                                        class="form-control entry-calc entry-calc-rupiah"
                                        value="{{ old('penyesuaian_gaji_lalu', $slip->penyesuaian_gaji_lalu) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bpjstk_iuran_jht_tk" id="bpjstk_iuran_jht_tk"
                                        class="form-control entry-calc entry-calc-rupiah bg-light" readonly
                                        value="{{ old('bpjstk_iuran_jht_tk', $slip->bpjstk_karyawan) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bpjstk_total" id="bpjstk_total"
                                        ...
                                        value="{{ old('bpjstk_total', $slip->bpjstk_perusahaan) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bpjsk_premi" id="bpjsk_premi"
                                        class="form-control entry-calc entry-calc-rupiah bg-light" readonly
                                        value="{{ old('bpjsk_premi', $slip->bpjsk_perusahaan) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="bpjsk_tg_karyawan" id="bpjsk_tg_karyawan"
                                        class="form-control entry-calc entry-calc-rupiah bg-light" readonly
                                        value="{{ old('bpjsk_tg_karyawan', $slip->bpjsk_karyawan) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-3">
                                ...
                                <input type="number" name="ijin_pulang_cepat" id="ijin_pulang_cepat" class="form-control"
                                    value="{{ old('ijin_pulang_cepat', $slip->ijin_pulang_awal) }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="no_check_in_or_out" id="no_check_in_or_out" class="form-control"
                                    value="{{ old('no_check_in_or_out', $slip->no_checkin_or_checkout) }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">No Check In & Out</label>
                                <input type="number" name="no_check_in_and_out" id="no_check_in_and_out"
                                    class="form-control"
                                    value="{{ old('no_check_in_and_out', $slip->no_checkin_and_checkout) }}">
                            </div>
                        </div>
                        <div class="row g-3 mb-4">
                            <div class="col-md-3">
                    ...
                    <div class="tab-pane fade" id="tab-ringkasan" role="tabpanel" aria-labelledby="tab-ringkasan-tab">
                        ...
                        <div id="resign_info_container" class="alert alert-warning border border-warning shadow-sm mb-4" style="display: none;">
                                ...
                                <div class="summary-card summary-card-income">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="calculated_penerimaan"
                                            ...
                                            readonly value="{{ number_format($slip->subtotal_penerimaan, 0, ',', '.') }}">
                                    </div>
                                ...
                                <div class="summary-card summary-card-thp">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nominal_transfer" id="nominal_transfer"
                                            ...
                                            required value="{{ old('nominal_transfer', $slip->total_diterima) }}">
                                    </div>
                                    <input type="hidden" name="bpjstk" id="bpjstk"
                                        value="{{ old('bpjstk', $slip->bpjstk_perusahaan) }}">
                                    <input type="hidden" name="bpjsk" id="bpjsk"
                                        value="{{ old('bpjsk', $slip->bpjsk_perusahaan) }}">
                                    <input type="hidden" name="potongan_bpjs_tk" id="potongan_bpjs_tk"
                                        value="{{ old('potongan_bpjs_tk', $slip->bpjstk_karyawan) }}">
                                    <input type="hidden" name="potongan_bpjs_kesehatan" id="potongan_bpjs_kesehatan"
                                        value="{{ old('potongan_bpjs_kesehatan', $slip->bpjsk_karyawan) }}">
                                    <input type="hidden" name="potongan_pph_21" id="potongan_pph_21"
                                        value="{{ old('potongan_pph_21', $slip->pph21) }}">
                                    <input type="hidden" name="thp" id="thp"
                                        value="{{ old('thp', $slip->total_diterima) }}">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            function fetchEmployeeDetails(isInitialLoad) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // If NOT initial edit load (e.g. employee selection changed), populate fields
                        if (!isInitialLoad) {
                            // --- Tab 2: Pendapatan & Tunjangan ---
                            if (data.gaji) {
                            ...
                            // On initial edit load, set metadata read-only info
                            if (data.bpjstk) {
                                $('#bpjsk_no_ref').val(data.bpjstk.no_referensi || '');
                                $('#bpjstk_tanggal_kepesertaan').val(data.bpjstk.tanggal_kepesertaan || '-');
                                $('#bpjsk_upah_daftar').val(formatRupiah(data.bpjstk.upah_didaftarkan));
            ...
            $('#id_karyawan').on('change', function () { fetchEmployeeDetails(false); });
